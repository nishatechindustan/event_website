  ...
  prepend_before_action :require_no_authentication, :only => [:create ]
    ...
    def create
      ...
      if resource.valid_password?(params[:password])
        ...
        userDetails = {:auth_token=>resource.auth_token, :email=>resource.email, :user_name => resource.user_name, :first_name=> resource.first_name, :last_name=> resource.last_name, :is_admin => resource.is_admin, :user_image=> @user_image}
